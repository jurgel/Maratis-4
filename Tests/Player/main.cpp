...
int main(int argc, char **argv)
{
    ...
    // create main window
    MWindow *window = MGUI_createWindow("Player", 10, 10, 800, 600, winEvents);
    if (!window)
    {
        MGUI_close();
        M_closeFreeImage();
